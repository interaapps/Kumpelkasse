    ...
    fun getDashboard(groupId: String?, currentUserId: String): DashboardResponse {
        ...
        if (groups.isEmpty()) {
            return DashboardResponse(
                ...
                directOwedByMe = emptyList(),
                directOwedToMe = emptyList(),
                optimizedOwedByMe = emptyList(),
                optimizedOwedToMe = emptyList(),
                owedByMe = emptyList(),
                owedToMe = emptyList(),
        ...
        return DashboardResponse(
            ...
            stats = stats,
            directOwedByMe = calculation.directOwedByMe,
            directOwedToMe = calculation.directOwedToMe,
            optimizedOwedByMe = calculation.optimizedOwedByMe,
            optimizedOwedToMe = calculation.optimizedOwedToMe,
            owedByMe = calculation.optimizedOwedByMe,
            owedToMe = calculation.optimizedOwedToMe,
